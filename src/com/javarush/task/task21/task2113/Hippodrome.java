...
public class Hippodrome {
    ...
    public void move(){
//        System.out.println("Этод метод управляет движением всех лошадей!");
        for (Horse workingHorse : horses) {
            workingHorse.move();
        }
    }

    public void print(){
//        System.out.println("Этод метод отрисовывает лошадей на экране!");
        for (Horse workingHorse : horses) {
            workingHorse.print();
        }
        for (int i = 0; i < 10; i++) {
    ...
    public void run() throws InterruptedException {
        System.out.println("Этод метод должен всем управлять!");
        for (int i = 0; i < 100; i++) {
            move();
            print();
            Thread.sleep(200);
    ...
    public Horse getWinner(){
        int maxdist = 0;
        int fastestId = 0;
        int ind = 0; // индекс лошади в hosrses
        for (Horse fastest : horses) {
            double dist = getHorses().get(ind).getDistance();
            if ((int) dist > maxdist){
                maxdist = (int) dist;
                fastestId = ind;
            }
        ...
        return getHorses().get(fastestId);
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Horse whiteHorse = new Horse("Белка",3, 0);
        Horse fastHorse = new Horse("Пуля",3,0);
        Horse fatHorse = new Horse("Бомба",3,0);
        horses.add(whiteHorse);
        horses.add(fastHorse);
        horses.add(fatHorse);
...
Требования:
•	В методе move класса Horse значение поля distance должно увеличиваться
...
•	В методе move класса Hippodrome должен быть вызван метод move по одному разу
...
Требования:
•	В классе Hippodrome должен быть создан метод void run() без параметров.
•	В классе Hippodrome должен быть создан метод void move() без параметров.
•	В классе Hippodrome должен быть создан метод void print() без параметров.
