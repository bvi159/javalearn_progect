...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        // Два потока могут работать одновременно с разными методами
        Thread thread1 = new Thread(() -> {
            System.out.println("Sum of var1 and var2: " + solution.getSumOfVar1AndVar2());
        });

        Thread thread2 = new Thread(() -> {
            System.out.println("Sum of var3 and var4: " + solution.getSumOfVar3AndVar4());
        });
