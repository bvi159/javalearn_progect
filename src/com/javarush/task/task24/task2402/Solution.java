...
public class Solution {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        Test1 clonedTest1 = test1.clone();
        System.out.println("Test1 cloned: " + (test1 != clonedTest1));

        Test2 test2 = new Test2();
        Test2 clonedTest2 = test2.clone();
        System.out.println("Test2 cloned: " + (test2 != clonedTest2));
