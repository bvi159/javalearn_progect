...
//    private boolean isManAnya = userAnya.isMan();
//    private boolean isManRoma = userRoma.isMan();
...
//        rate = (int) ((base.get() + age / 100) * (hasWork ? 1.1 : 0.9));
    rate = (int) ((((base.get() + age / 100) * (hasWork ? 1.1 : 0.9))) * (hasHouse ? 1.1 : 0.9));
    return rate;
}
