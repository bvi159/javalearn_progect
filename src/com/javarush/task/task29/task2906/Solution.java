...
Исправь ошибку реализации, приводящую к NullPointerException,
в методе getValue(). Читай доп. статью про особенности автобоксинга.
...
public class Solution {
    ...
    public static Integer getValue(Boolean first, Boolean second) {
//        return first ? 100 : second ? 200 : null;
        return first ? (first ? 100 : (second ? 200 : null)) : (second ? 200 : null);
    }
}
